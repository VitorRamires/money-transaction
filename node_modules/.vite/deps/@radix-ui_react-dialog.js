...
var DialogOverlayImpl = React15.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsx)(Combination_default, { as: Slot, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime4.jsx)(
      Primitive.div,
      {
        "data-state": getState(context.open),
        ...overlayProps,
